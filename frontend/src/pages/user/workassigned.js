...
function Workassigned() {
  const work= [
    ...
    { caseid: 55764, reporttitle: 'home visitation', status: 'Pending', category:'Desk', assignedon: '2024-04-16 09:11' },
    { caseid: 55766, reporttitle: 'home inspection', status: 'Completed', category:'Field', assignedon: '2024-04-18 11:11' },
    { caseid: 55767, reporttitle: 'check allocation', status: 'Pending', category:'Desk', assignedon: '2024-04-19 12:11' },
    { caseid: 55769, reporttitle:'home inspection', status: 'Completed', category:'Field', assignedon: '2024-04-21 14:11' },
    { caseid: 55770, reporttitle: 'home inspection', status: 'Pending', category:'Field', assignedon:'2024-04-22 15:11' },
              ...
              {filteredWork.map(works=> (
                <tr key={works.id}>
                  ...
                  <td className="px-4 py-2 border border-black">
                    <p className={`border p-1 rounded-xl ${works.status === 'Completed' ? 'border-green-600' : 'border-red-600'}`}>
                      {works.status}
                    </p>
                  </td>
